                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              image: AssetImage("assets/images/profiles/Emma Smith.jpg"),
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
                ...
                Stack(
                  children: [
                    Container(
                      ...
                      child: CircleAvatar(
                        radius: 60,
                        backgroundImage: AssetImage("assets/images/profiles/Emma Smith.jpg"),
                      ),
                    ),
                    if (isEditing)
                      Positioned(
              ...
              children: [
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: showDetails ? Colors.green : Colors.grey[300],
                  ...
                  GestureDetector(
                    ...
                    child: Column(
                      children: [
                        Icon(
                          Icons.photo_library,
                          color: showPictures ? Colors.green : Colors.grey,
                        ),
                        SizedBox(height: 4),
                        Container(
                          height: 2,
                          width: 40,
                          color: showPictures ? Colors.green : Colors.transparent,
                        ),
                      ],
                    ),
                  ),
                  ...
                  showPictures ? 4 : 2,
                    ...
                    children: [
                      ClipRRect(
                        ...
                        child: Image.asset(
                          showPictures
                              ? "assets/images/tables/Gallery image 1.jpg"
                              : "assets/images/tables/Gallery image 1.jpg",
                          fit: BoxFit.cover,
                        ),
                      ),
